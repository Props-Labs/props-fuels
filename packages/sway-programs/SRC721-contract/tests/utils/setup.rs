...
abigen!(Contract(
    name = "SRC721",
    abi = "./SRC721-contract/out/debug/SRC721-contract-abi.json"
),);

const NFT_CONTRACT_BINARY_PATH: &str = "./out/debug/SRC721-contract.bin";
...
pub(crate) async fn setup() -> (
    ...
    let instance_1 = SRC721::new(id.clone(), wallet1.clone());
    let instance_2 = SRC721::new(id.clone(), wallet2.clone());
