...
abigen!(Contract(
    name = "SRC721EditionImmutable",
    abi = "./SRC721EditionImmutableImmutable-contract/out/debug/SRC721EditionImmutableImmutable-contract-abi.json"
),);

const NFT_CONTRACT_BINARY_PATH: &str = "./out/debug/SRC721EditionImmutableImmutable-contract.bin";
...
pub(crate) async fn setup() -> (
    ...
    WalletUnlocked,
    ContractId,
    SRC721EditionImmutable<WalletUnlocked>,
    SRC721EditionImmutable<WalletUnlocked>,
) {
    ...
    let instance_1 = SRC721EditionImmutable::new(id.clone(), wallet1.clone());
    let instance_2 = SRC721EditionImmutable::new(id.clone(), wallet2.clone());
