...
use interface::{SRC721EditionImmutable, SetMintMetadata, SRC3PayableExtension};
...
configurable {
    ...
    MAX_SUPPLY: u64 = 3,
    NAME: String = "Editions",
    SYMBOL: String = "EDT",
    METADATA: Struct {
        keys: Vec<String> = Vec::new(),
        values: Vec<Metadata> = Vec::new(),
    },
}
...
impl SRC721EditionImmutable for Contract {
