...
mod success {
    ...
    //     let response = mint(&instance_1, other_identity, sub_id_1, 1, 0, fee_id, None, None, None, None).await;
    ...
    //     constructor(&instance_1, owner_identity, default_name(), default_symbol(), default_metadata_keys(), default_metadata_values(), default_price(), default_start_date(), default_end_date()).await;
    //     mint(&instance_1, other_identity, sub_id_1, 1, 0, fee_id, None, None, None, None).await;
    ...
    //     mint(&instance_1, other_identity, sub_id_2, 1, 0, fee_id, None, None, None, None).await;
    ...
    //     mint(&instance_1, other_identity, sub_id_3, 1, 0, fee_id, None, None, None, None).await;
    ...
    //     let response = mint(&instance_1, other_identity, sub_id_1, 1, 1_000, fee_id, None, None, None, None).await;
    //     let logs = response.decode_logs();
    //     println!("{:?}", logs);
    ...
    //     mint(&instance_1, other_identity, sub_id_1, 1, 1_000, fee_id, None, None, None, None).await;
    ...
    //     mint(&instance_1, other_identity, sub_id_1, 1, 2_000, fee_id, None, None, None, None).await;
    ...
    //     let response = mint(&instance_1, other_identity, sub_id_1, 1, 2_000, fee_id, None, None, None, None).await;
    //     let logs = response.decode_logs();
    //     println!("{:?}", logs);
    ...
    //     let response = mint(&instance_2, other_identity, sub_id_1, 1, 1_000, fee_id, None, None, None, None).await;
    //     let logs = response.decode_logs();
    //     println!("{:?}", logs);
    ...
    //     let response = mint(&instance_2, other_identity, sub_id_1, 1, 1_000, fee_id, Some(Identity::Address(another_wallet.address().into())), None, None, None).await;
    //     let logs = response.decode_logs();
    //     println!("{:?}", logs);
    ...
    #[tokio::test]
    async fn mint_with_merkle_proof() {
        ...
        println!("Owner recipient bytes: {:?}", owner_recipient_bytes);
        ...
        println!("Other recipient bytes: {:?}", other_recipient_bytes);
        ...
        println!("Bits256 proof: {:?}", bits256_proof);
        ...
        let response = mint(&instance_2, owner_identity, sub_id_1, 3, 0, fee_id, None, Some(bits256_proof), Some(key), Some(num_leaves)).await;
        let logs = response.decode_logs();
        println!("{:?}", logs);
...
mod revert {
    ...
    //     mint(&instance_2, other_identity, sub_id_1, 1, 0, fee_id, None, None, None, None).await;
    // }
    ...
    //     mint(&instance_1, other_identity, sub_id_2, 1, 0, fee_id, None, None, None, None).await;
    //     mint(&instance_1, other_identity, sub_id_3, 1, 0, fee_id, None, None, None, None).await;
    //     mint(&instance_1, other_identity, Bits256([4u8; 32]), 1, 0, fee_id, None, None, None, None).await;
    // }
    ...
    //     mint(&instance_1, other_identity, sub_id_1, 1, 500, fee_id, None, None, None, None).await;
    // }
    ...
    //     mint(&instance_1, other_identity, sub_id_1, 1, 1_000, fee_id, None, None, None, None).await;
    //     mint(&instance_1, other_identity, sub_id_2, 1, 1_500, fee_id, None, None, None, None).await;
    ...
    //     mint(&instance_1, other_identity, sub_id_1, 1, default_price(), fee_id, None, None, None, None).await;
    // }
