...
export enum DistributionErrorInput { CanNotSendZero = 'CanNotSendZero' };
export enum DistributionErrorOutput { CanNotSendZero = 'CanNotSendZero' };
...
interface OctaneFeeSplitterContractAbiInterface extends Interface {
  functions: {
...
export class OctaneFeeSplitterContractAbi extends Contract {
  interface: OctaneFeeSplitterContractAbiInterface;
  functions: {
