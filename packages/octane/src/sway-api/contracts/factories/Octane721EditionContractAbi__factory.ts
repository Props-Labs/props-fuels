...
import type { Octane721EditionContractAbi, Octane721EditionContractAbiInterface } from "../Octane721EditionContractAbi";
...
export const Octane721EditionContractAbi__factory = {
  abi: _abi,

  storageSlots: _storageSlots,

  createInterface(): Octane721EditionContractAbiInterface {
    return new Interface(_abi) as unknown as Octane721EditionContractAbiInterface
  },

  connect(
    id: string | AbstractAddress,
    accountOrProvider: Account | Provider
  ): Octane721EditionContractAbi {
    return new Contract(id, _abi, accountOrProvider) as unknown as Octane721EditionContractAbi
  },
  ...
  ): Promise<DeployContractResult<Octane721EditionContractAbi>> {
    const factory = new ContractFactory(bytecode, _abi, wallet);

    return factory.deployContract<Octane721EditionContractAbi>({
      storageSlots: _storageSlots,
      ...options,
    });
  },
