...
import type { OctaneFeeSplitterContractAbi, OctaneFeeSplitterContractAbiInterface } from "../OctaneFeeSplitterContractAbi";
...
export const OctaneFeeSplitterContractAbi__factory = {
  abi: _abi,

  storageSlots: _storageSlots,

  createInterface(): OctaneFeeSplitterContractAbiInterface {
    return new Interface(_abi) as unknown as OctaneFeeSplitterContractAbiInterface
  },

  connect(
    id: string | AbstractAddress,
    accountOrProvider: Account | Provider
  ): OctaneFeeSplitterContractAbi {
    return new Contract(id, _abi, accountOrProvider) as unknown as OctaneFeeSplitterContractAbi
  },
  ...
  ): Promise<DeployContractResult<OctaneFeeSplitterContractAbi>> {
    const factory = new ContractFactory(bytecode, _abi, wallet);

    return factory.deployContract<OctaneFeeSplitterContractAbi>({
      storageSlots: _storageSlots,
      ...options,
    });
  },
